# Flyingdarts - WebSockets - OnConnect


For more information about how the WebSockets work and how we go about with them, view the Endpoints project [README](https://github.com/flyingdarts/IYLTDSU.WebSockets.Endpoints/blob/main/README.md) in GitHub.
...
Deploy application
```
    cd "IYLTDSU.WebSockets.Endpoint.OnConnect/src/IYLTDSU.WebSockets.Endpoint.OnConnect"
